...
from ....common.models import BasketList
from ....common.enums import ResponseStatus, PriceType, TransactionType
from ....utils.decoders import build_loader, datetime_decoder

__all__ = ['GetBasketMarginRequestModel', 'GetBasketMarginResponseModel']

class GetBasketMarginRequestModel(BaseModel):
  """
  ...
  snonum: Optional[str]
  """Optional field. Application only for H or B order modification"""
  basketlists: Optional[List[BasketList]]
  """Array of basketlist"""

class GetBasketMarginResponseModel(BaseModel):
  """
